...
П-строки - длина максимального собтвенного суффикса, 
...
Могу ли я узнать префикс функцию для данной строки с еще одним символом, 
если мне известна префикс-функция для всех подстрок П для s[:i] это функция среза строки.
'''
#
